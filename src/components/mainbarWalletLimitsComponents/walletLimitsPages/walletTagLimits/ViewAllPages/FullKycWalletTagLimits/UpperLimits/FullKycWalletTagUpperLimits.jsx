...
import './FullKycWalletTagUpperLimits.css'

const FullKycWalletTagUpperLimits = ({ walletTagFullKycLimits,setViewAll}) => {
  return (
        ...
        <div className="table-data-container">
          ...
          <div className="tbody-scroll">
            <table className="table-body">
              <tbody>
                {walletTagFullKycLimits.map((item, index) => (
...
export default FullKycWalletTagUpperLimits
