  ...
  import RegulatoryAuthorityLimits from '../components/mainbarWalletLimitsComponents/walletLimitsPages/RegulatoryAuthorityLimits';
  import IssuerLimits from '../components/mainbarWalletLimitsComponents/walletLimitsPages/IssuerLimits';
  import ProgramManagerLimits from '../components/mainbarWalletLimitsComponents/walletLimitsPages/ProgramManagerLimits';
    ...
    return (
      ...
      <Route path='/superadmin/' element={<SuperadminDashboard/>}>
          ...
          <Route path='walletlimits' element={<WalletLimits/>}>
            ...
            <Route path='FullKYCUpperLimits' element={<FullKYCUpperLimits/>}/>
            </Route>
          </Route>
      </Route>
      </Routes>
